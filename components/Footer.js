    ...
    <div>
      <div className={styles.footermain}>
        <div className={styles.section1}>
            ...
            <p>Ready to get started on your project? Contact us today and let us help you bring your ideas to life.</p>
        </div>
      ...
      <h3>Menu</h3>
        ...
        <div className={styles.section4}>
            ...
            <p style={{marginBottom:"-7px"}}  >Email: info@Info@speedomassco
mmunication.com
</p>
...
<div className={styles.icons}>
    ...
    <img src="twitter.png" alt="" />
      ...
      <div className={styles.footerlow}>
        <p>Copyright © 2023 speedomass | All rights reserved designed by Syed Sameed Ali</p>
      </div>
    </div>
  )
}
